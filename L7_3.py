...
class Cell:
    ...
    def __truediv__(self, other):
       if other.number >= self.number:
           return Cell(round(other.number / self.number))
       else:
...
cells2 = Cell(5)
print(cells1)
print(f'{cells1 + cells2} (Сумма)')
print(f'{cells2 - cells1} (Разность)')
print(f'{cells1 - cells2} (Разность)')
print(f'{cells1 / cells2} (Деление)')
